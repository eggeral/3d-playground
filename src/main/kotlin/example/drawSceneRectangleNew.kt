...
fun drawSceneRectangleNew(gl: WebGLRenderingContext) {

    val center = Coordinate(0.0f, 1.0f, 0.0f)
    val rectSize = 1.0f
    val rectColor = Rgba(0.0f, 1.0f, 0.0f, 1.0f)
    val rectangle = createSquare(center, rectSize, rectColor)
    val rectColors = rectangle.getColors()
    ...
    gl.bufferData(
            WebGLRenderingContext.ARRAY_BUFFER,
            Float32Array(rectangle.getVertices()),
            WebGLRenderingContext.STATIC_DRAW)

    val colorBuffer = gl.createBuffer()
    gl.bindBuffer(WebGLRenderingContext.ARRAY_BUFFER, colorBuffer)
    gl.bufferData(WebGLRenderingContext.ARRAY_BUFFER, Float32Array(rectColors), WebGLRenderingContext.STATIC_DRAW)
